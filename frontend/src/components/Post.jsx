...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://social-media-6rjz.onrender.com/api/v1/post/${post._id}/${action}`, { withCredentials: true });
    ...
    const commentHandler = async () => {
        ...
        try {
            const res = await axios.post(`https://social-media-6rjz.onrender.com/api/v1/post/${post._id}/comment`, { text }, {
                headers: {
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`https://social-media-6rjz.onrender.com/api/v1/post/delete/${post?._id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const bookmarkHandler = async () => {
        try {
            const res = await axios.get(`https://social-media-6rjz.onrender.com/api/v1/post/${post?._id}/bookmark`, { withCredentials: true });
            if (res.data.success) {
                toast.success(res.data.message);
            }
        } catch (error) {
